...
const RequestUsers = () => {
   ...
   const handleApprove = async (code: string) => {
      ...
      try {
         ...
         // add blockchain
         if (response.data.data.role === roles[roles.factory]) {
            await supplychainContract.addFactory(response.data.data.addressWallet);
         } else if (response.data.data.role === roles[roles.agent]) {
            await supplychainContract.addAgent(response.data.data.addressWallet);
         }
