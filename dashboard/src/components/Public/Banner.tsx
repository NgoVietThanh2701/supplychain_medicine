...
const Card = ({ data }: any) => {
   return (
      <div className='flex w-full bg-background-slide bg-cover h-[666px] items-center'>
         <div className='w-2/5 flex flex-col gap-6 ml-32 pt-20'>
            ...
            <button className='text-white mx-auto bg-blue-400 rounded-3xl text-lg py-3 px-6 mt-3'>What you do</button>
         </div>
