...
const Header = () => {
   ...
   useEffect(() => {
      if (isLoggedIn && ((currentUser?.role === roles[roles.admin]) || currentUser?.role === roles[roles.factory] || currentUser?.role === roles[roles.agent] || currentUser?.role === roles[roles.deliveryhub])) {
