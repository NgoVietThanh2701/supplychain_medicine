...
const ProductCard = ({ product }: any) => {
   return (
      <div className='border-item-product pb-3 pt-1 flex flex-col items-center gap-2.5 group relative'>
         ...
         <span className='text-green font-bold '>$ {product.priceAgent} AGT</span>
         <div className='text-gray-500 flex justify-center gap-3 text-sm items-center w-full px-5 mt-2'>
            <span>{product?.nsx}</span>
         </div>
      </div>
   )
}
